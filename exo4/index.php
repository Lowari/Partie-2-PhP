...
switch ($magnitude) {
    case 1:
        ...
        break;
    case 2:
        $result = "Micro-séisme impossible à ressentir mais enregistrable par les sismomètre";
        break;
    case 3:
        $result = "Ne cause pas de dégats mais commence à pouvoir être légrement ressentit";
        break;
    case 4:
...
<body>
    ...
    <p>Magnitude de <?= $magnitude ?> : <?= $result; ?>.</p>
